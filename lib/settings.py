...
SECRET_KEY = 'django-insecure-t0gcxzlqjb#i!f-q6*$i$zpbfd!00ju=paadmz(8-)aki_t(^$'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'database_lib',  #nombre base de datos xamp
        'USER': 'root',
        'PASSWORD':''
    }
}
...
# Static files
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # apunta a tu carpeta static
